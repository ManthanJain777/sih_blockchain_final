...
export function EnhancedVerificationModule() {
  ...
  return (
    <Card className="p-8 bg-card border-2 border-border/50 shadow-xl relative overflow-hidden">
      ...
      <h3 className="text-card-foreground mb-6 font-bold text-2xl uppercase tracking-wide relative z-10">Verify Media on Polkadot</h3>
        ...
        {verificationResult && (
          <div className="mt-8 space-y-5">
            <div className="flex items-center gap-3 p-5 bg-gradient-to-r from-[#2DD4BF]/20 to-[#3B82F6]/20 border-2 border-[#2DD4BF] rounded-2xl shadow-lg">
              ...
              <span className="text-card-foreground font-bold text-lg">Verification Successful on {verificationResult.parachain}!</span>
            </div>
